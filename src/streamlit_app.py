...
async def main() -> None:
    ...
    with st.sidebar:
        ...
        def architecture_dialog() -> None:
            st.image("/home/delen018/Tricog/drone_detection_result10.jpg")
        ...
        st.caption(
            "Made with :material/favorite: by [Somasree](https://www.linkedin.com/in/somasree-majumder-3533411aa/)"
        )
